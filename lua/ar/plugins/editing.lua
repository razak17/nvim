...
return {
  ...
  },
  {
    ...
    -- stylua: ignore
    keys = {
      { mode = { 'n', 'x' }, '<C-w>p', '<Plug>(YankyPutAfter)', desc = 'yanky: put after', },
      { mode = { 'n', 'x' }, '<C-w>P', '<Plug>(YankyPutBefore)', desc = 'yanky: put before', },
      { mode = { 'n', 'x' }, '<C-w>yp', '<Plug>(YankyGPutAfter)', desc = 'yanky: gput after', },
      { mode = { 'n', 'x' }, '<C-w>yP', '<Plug>(YankyGPutBefore)', desc = 'yanky: gput before', },
      { '<C-w>yy', '<Plug>(YankyYank)', desc = 'yanky: yank Text' },
      { '<C-w>yn', '<Plug>(YankyCycleForward)', desc = 'yanky: cycle forward' },
      { '<C-w>yb', '<Plug>(YankyCycleBackward)', desc = 'yanky: cycle backward' },
      { '<C-w>yo', '<Cmd>YankyRingHistory<CR>', desc = 'yanky: open yank history', },
    },

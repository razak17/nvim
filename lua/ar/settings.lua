...
if ar.config.fold.variant ~= 'custom' then opt.foldtext = '' end
...
opt.wildignore =
  vim.list_extend(vim.deepcopy(wildignore), ui.colorscheme.disabled)
...
-- o.titleold = fn.fnamemodify(vim.env.SHELL, ':t')
o.title = true
o.titlelen = 70
--------------------------------------------------------------------------------
-- Utilities {{{1

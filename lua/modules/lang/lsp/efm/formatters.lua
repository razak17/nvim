...
-- local lua_no_simple_func = ' --keep-simple-function-one-line'
-- local lua_break = ' --break-after-table-lb --break-before-table-rb --chop-down-table '
-- local lua_limit = ' --align-parameter --chop-down-parameter --column-limit=100'

-- M.luaFormat = {
--   formatCommand = "lua-format -i" .. lua_indent .. lua_no_simple_block .. lua_no_simple_func ..
--       lua_break .. lua_limit,
--   formatStdin = true
-- }
...
M.prettier = {formatCommand = "prettier --stdin-filepath ${INPUT}", formatStdin = true}
M.prettier_yaml = {formatCommand = "prettier --stdin-filepath ${INPUT}", formatStdin = true}

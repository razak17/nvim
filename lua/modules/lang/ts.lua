...
local fts = {
    "c", "cpp", "css", "erlang", "graphql", "go", "haskell", "html",
    "javascript", "jsdoc", "julia", "json", "lua", "python", "rust", "sh",
    "toml", "tsx", "typescript", "yaml"
}

local parsers = {
    "bash", "c", "cpp", "css", "erlang", "graphql", "go", "haskell", "html",
    "javascript", "jsdoc", "julia", "json", "lua", "python", "rust", "toml",
    "tsx", "typescript", "yaml"
}

...
function zephyr.load_syntax()
  local syntax = {
    ...
    IncSearch = { fg = zephyr.bg, bg = zephyr.orange, style = zephyr.none },
    ...
    NonText = { fg = zephyr.bg },
    Whitespace = { fg = zephyr.base4 },
    SpecialKey = { fg = zephyr.bg },
...
function zephyr.load_plugin_syntax()
  local plugin_syntax = {
    ...
    -- NvimTreeNormal = { bg = zephyr.alt_bg },
    -- NvimTreeNormalNC = { bg = zephyr.alt_bg },
    -- NvimTreeSignColumn = { bg = zephyr.alt_bg },
    -- NvimTreeEndOfBuffer = { bg = zephyr.alt_bg },
    NvimTreeFolderIcon = { fg = zephyr.blue },
    NvimTreeIndentMarker = { fg = zephyr.base6 },
    NvimTreeVertSplit = { fg = zephyr.blue, bg = zephyr.yellow },
    NvimTreeImageFile = { fg = zephyr.purple },
    NvimTreeSpecialFile = { fg = zephyr.orange },
    NvimTreeGitStaged = { fg = zephyr.sign_add },
    NvimTreeCursorLine = { bg = zephyr.red },
    NvimTreeGitNew = { fg = zephyr.sign_add },
    NvimTreeGitDirty = { fg = zephyr.sign_add },
    NvimTreeGitDeleted = { fg = zephyr.sign_delete },
    NvimTreeGitMerge = { fg = zephyr.sign_change },
    NvimTreeGitRenamed = { fg = zephyr.sign_change },
    NvimTreeSymlink = { fg = zephyr.cyan },
    NvimTreeExecFile = { fg = zephyr.green },

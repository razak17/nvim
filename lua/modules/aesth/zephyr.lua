...
function zephyr.load_plugin_syntax()
	local plugin_syntax = {
		...
		LspDiagnosticsVirtualTextError = { fg = zephyr.pale_red, bg = zephyr.light_red },
		LspDiagnosticsVirtualTextWarning = { fg = zephyr.dark_orange, bg = zephyr.light_yellow },
		LspDiagnosticsVirtualTextInformation = { fg = zephyr.blue, bg = zephyr.light_blue },
		LspDiagnosticsVirtualTextHint = { fg = zephyr.teal, bg = zephyr.light_teal },

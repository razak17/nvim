...
function zephyr.load_syntax()
  local syntax = {
    ...
    Folded = { fg = P.grey, bg = P.bg_highlight2 },
    ...
    ColorColumn = { fg = P.none, bg = P.dark2 },
    CursorIM = { fg = P.none, bg = P.none, style = "reverse" },
    CursorColumn = { fg = P.none, bg = P.dark2 },
    CursorLine = { fg = P.none, bg = P.dark2 },
...
function zephyr.load_plugin_syntax()
  local plugin_syntax = {
    ...
    TroubleCount = { bg = P.bg_highlight2, fg = P.magenta },

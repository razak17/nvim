...
--     end,
--     separator = ' ',
--     separator_highlight = {colrs.yellow,function()
...
gls.left[2] = {
  ViMode = {
    provider = function()
      ...
      if hasValue(vimodes, vim.fn.mode()) then
        vim.api.nvim_command('hi GalaxyViMode guibg='..mode_color[vim.fn.mode()])
      else
        vim.api.nvim_command('hi GalaxyViMode guibg='..mode_color['^V'])
      end
      return '  Neovim '
    end,
    separator = ' ',

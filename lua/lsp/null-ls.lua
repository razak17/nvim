...
local function register_failed_request(ft, provider, operation)
  if not rvim.lang[ft][operation]._failed_requests then
    rvim.lang[ft][operation]._failed_requests = {}
  end
  table.insert(rvim.lang[ft][operation]._failed_requests, provider)
end

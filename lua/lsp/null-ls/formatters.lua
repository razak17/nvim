...
function M.setup(filetype, options)
  if formatters_by_ft[filetype] or (formatters_by_ft[filetype] and not options.force_reload) then
    return
  end

  formatters_by_ft[filetype] = M.list_configured(rvim.lang[filetype].formatters)
